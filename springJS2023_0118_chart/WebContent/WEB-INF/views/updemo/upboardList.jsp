...
<style>
  ...
  <c:forEach var="e" items="${list }">
      <tr>
        ...
        <td class="align-middle"><img src="${pageContext.request.contextPath}/resources/imgfile/${e.imgn }"
...
<th colspan="5" style="text-align: center; ">
    ...
    <tr>
      ...
      footer.jsp에서 작성.
       -->     
    <button type="button" class="btn btn-outline-danger" id="wbtn2">글작성</button>
      </td></tr>
