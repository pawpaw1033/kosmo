 ...
 <table class="table">
		...
		<tbody>
			...
			<input type="text" name="sub" id="sub" value="${vo.sub}"
							readonly="readonly"> 
		 <input type="hidden" name="subcode" value="${vo.num }" id="subcode">
			</td>
			</tr>
		...
		<tfoot>
			<tr>
				...
				<input type="button" value="list"
					...
					<input type="button" value="chart" onclick="location='${pageContext.request.contextPath}/web/mychart/SurveyDonutChartAjaxTitle?num=${vo.num}'"></th>
			</tr>
		</tfoot>
	</table> 
	</form>
