...
public class MemberModelAttrDemo {
	...
	// 파라미터 처리 HttpServletRequest request WAS에서 DispatcherServlet에서 왔다가 SpringContainer에 의해서 주입 받는다.
	...
	public String addTest(Model model, @ModelAttribute(value = "vo") MemberDemoVO vo) {
		System.out.println("ID4 =>"+vo.getId());
		System.out.println("PWD4 =>"+vo.getPwd());
		System.out.println("NAME4 =>"+vo.getUname());
